                                              ...
                                              const int m_player_id          )
{
    ...
    static int s_transmit_cnt = 0;
    if (++s_transmit_cnt <= 20)
        Log::info("PlayerKartWidget", "transmitEvent: player=%d origin='%s' disp=%d",
                  m_player_id, originator.c_str(), m_display_id);
