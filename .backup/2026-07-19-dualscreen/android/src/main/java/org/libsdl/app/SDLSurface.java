...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        // Diagnostic: log first few touch events per surface
        if (mTouchLogCount < 10) {
            mTouchLogCount++;
            Log.v("SDL", "onTouch: display=" + mDisplayId + " routedDevId=" + routedDevId
                  + " action=" + action + " androidDevId=" + touchDevId
