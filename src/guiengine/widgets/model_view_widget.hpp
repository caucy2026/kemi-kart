...
namespace GUIEngine
{
    ...
    public:
        ...
        /** Set visibility of the 3D model scene nodes.
         *  Used by dual-screen syncDisplayWidgets to prevent cross-display
         *  model contamination in the shared scene manager. */
