...
namespace GUIEngine
{
    ...
    public:
        ...
        /**
         * \brief Called before each dual-screen render pass to sync widget
         *        visibility for the current display.
         * \param display_id  0=Display0, 2=Display2
         */
        virtual void syncDisplayWidgets(int display_id) { }
