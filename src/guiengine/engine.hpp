...
namespace GUIEngine
{
    ...
    /**
      * \brief Set the current display for dual-screen widget filtering.
      * \param id  -1=all, 0=Display0, 2=Display2
      */
    inline void setCurrentDisplayId(int id) { Private::g_current_display_id = id; }

    /**
      * \brief Get the current display for dual-screen widget filtering.
      */
    inline int getCurrentDisplayId() { return Private::g_current_display_id; }
